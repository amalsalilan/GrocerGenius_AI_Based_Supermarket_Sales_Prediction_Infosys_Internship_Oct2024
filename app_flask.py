...
model = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\best_xgb_model.pkl')
scaler = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\scaler.pkl')
standard_scaler = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\standard_scaler.pkl')
yeo_johnson = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\yeo_johnson.pkl')
one_hot_encoder = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\one_hot_encoder.pkl')
ordinal_encoder = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\ordinal_encoder.pkl')

# Load additional pre-computed values
item_weight_medians = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\item_weight_medians.pkl')
outlet_size_modes = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\outlet_size_modes.pkl')
median_visibility = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\median_visibility.pkl')
loo_encodings = joblib.load('C:\\Users\\anjan\\download\\Documents\\encoders\\loo_encodings.pkl')
